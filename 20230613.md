...
class MainWindow(QWidget):
    def __init__(self, parent=None):
        ...
        originalButton = QPushButton('reset', self)
        ...
        buttonLayout.addWidget(pencilSketchButton)
...
- 불러오기 (open 버튼으로 사진을 불러옴)

![Screenshot from 2023-06-13 11-14-57](https://github.com/ajhwan/OpenCV_study/assets/129160008/5245cde9-fe1e-4229-9f8c-ca14858d3ea1)

- 스케치 효과 (pencilSketch효과를 줌)

![Screenshot from 2023-06-13 11-15-04](https://github.com/ajhwan/OpenCV_study/assets/129160008/21ae15b3-c51d-4f89-ad63-fd9db6c454b3)

- 원래 사진으로 되돌리기 (원본 사진으로 되돌림)

![Screenshot from 2023-06-13 11-15-10](https://github.com/ajhwan/OpenCV_study/assets/129160008/f8a55593-cab5-44a1-9eb8-40b0fd9f6cbe)
