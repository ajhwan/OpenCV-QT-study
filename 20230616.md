...
class MainWindow(QWidget):
    ...
    def onSelectionItem(self):
        ...
        self.selction = self.listWidget.currentRow()
        print('onSelectionItem selectino: ', self.selection)
    ...
    def onClickAdd(self):
        ...
        self.selction = itemSize

        print('onClicekAdd selection: ', self.selection)
